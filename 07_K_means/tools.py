...
def image_to_numpy(path: str = 'C:/Users/Yann/OneDrive - ECAM Strasbourg-Europe/01 Yann/ECAM 5/Data mining & machine learning/T809DATA_2023/07_K_means/images/buoys.png'):
    '''
